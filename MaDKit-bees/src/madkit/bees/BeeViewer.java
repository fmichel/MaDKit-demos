...
//		Collection<String> classes = Arrays.asList("madkit.bees.Bee","madkit.bees.QueenBee");
//		jmenubar.add(new AgentsMenu(AgentAction.AGENT_LAUNCH_AGENT.getAction(this), classes));
//		jmenubar.add(GUIToolkit.createAgentsMenu(this));
